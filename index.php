                ...
                <div class="project col-lg">                
                    ...
                    <div class="project-des">
                        <a href="https://wordpress.org/plugins/terms-gate/" target="_blank">
                            <h3 class="from-right show-on-scroll">Terms Gate 
                            <i class="fa-brands fa-php"></i>
                            </h3>
                        </a>                       
                        <a href="https://github.com/got0values/terms-gate" target="_blank"><button>View Code</button></a>
                        <p class="appear show-on-scroll ln-ht">A Wordpress plugin that lets users require visitors to agree to terms, privacy policy, or any custom agreement before they can view specific posts or pages.<br><br><b>Technologies used:</b><br><i>PHP, Wordpress</i></p>
                    </div>
                </div>                
